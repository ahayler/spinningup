...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='HalfCheetah-v5') #'HalfCheetah-v2' (does not work because MujoCo-py doesn't)
    ...
    parser.add_argument('--epochs', type=int, default=800) # 50
